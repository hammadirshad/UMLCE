...
<div class="page-content">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="#">Add New Permission Level</a></li>
		</ul>
			...
			<div
				...
				<div class="portlet box blue">
					...
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<c:url value="/portal/permission/create" var="loginUrl" />
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<form:input type="text" id="name" path="name"
												value="${permissionbean.name}" class="form-control"
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<form:checkbox path="levels" value="create"
												class="make-switch" data-on-text="ON" />
										</div>
									</div>
									<div class="col-md-6">
