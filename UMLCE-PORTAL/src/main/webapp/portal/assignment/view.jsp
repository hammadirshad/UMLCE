			...
			<div
				...
				<div class="portlet box blue">
					<div class="portlet-title">
						<div class="caption">
							<i class="fa fa-gift"></i>Assignment Detail
						</div>
						<div class="tools">
										...
										<table class="table table-hover">
											...
											<tbody>
												<c:forEach items="${assignmentList}" var="assignment">
													<tr>
														<td>${assignment.id}</td>
														<td><c:if test="${assignment.attach>0}">
																<i class="fa fa-download"></i>
															</c:if></td>
														<td><a href="submit?query=${assignment.id}">
																${assignment.title}</a></td>
														<td>${assignment.startDate}</td>
														<td>${assignment.endDate}</td>
														<td><span class="label label-sm label-success">
																${assignment.owner.fname}&nbsp;${assignment.owner.lname}
														</span></td>
													</tr>
