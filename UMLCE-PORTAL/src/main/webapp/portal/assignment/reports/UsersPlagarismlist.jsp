												...
												<c:forEach items="${plagarisms}" var="plagarism">
													<tr>
														...
														<td><c:if test="${plagarism.less50>0}">
																<a
																	href="userplagarism?user=${plagarism.username}&plagarism=less50">
															</c:if> ${plagarism.less50}&nbsp;Assignments</td>
														<td><c:if test="${plagarism.above50>0}">
																<a
																	href="userplagarism?user=${plagarism.username}&plagarism=above50">
															</c:if> ${plagarism.above50}&nbsp;Assignments</td>
														<td><c:if test="${plagarism.above80>0}">
																<a
																	href="userplagarism?user=${plagarism.username}&plagarism=above80">
															</c:if> ${plagarism.above80}&nbsp;Assignments</td>
														<td><c:if test="${plagarism.aboveaverage>0}">
																<a
																	href="userplagarism?user=${plagarism.username}&plagarism=aboveaverage">
															</c:if> ${plagarism.aboveaverage}&nbsp;Assignments</td>
													</tr>
